...
namespace Tunynet.Common
{
    ...
    public static class NameValueCollectionExtension
    {
        ...
        public static string GetString(this NameValueCollection collection, HttpContext httpContext, string key, string defaultValue)
        {
            ...
            {
                var queryString = httpContext.Request.QueryString.Value.ToString().GetQueryString();
