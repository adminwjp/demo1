...
//        /// <param name="handlerFactory"></param>
//        public static Route MapHttpHandler<THandler>(this RouteCollection routes, string name, string url, object defaults, object constraints, Func<RequestContext, THandler> handlerFactory)
//            //where THandler 
//            //: IHttpHandler
//        {
