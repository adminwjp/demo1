...
namespace Tunynet.Common
{
    ...
    public static class HtmlHelperMessageExtensions
    {
        ...
        /// <returns></returns>
        public static IHtmlContent PresetMessage(this HtmlHelper htmlHelper, string messageContent, bool isHighlight)
        {
        ...
        public static IHtmlContent StatusMessage(this HtmlHelper htmlHelper, StatusMessageData statusMessageData = null, int hintMillisecondForHide = -1, int successMillisecondForHide = 2)
        {
