...
namespace Tunynet.Common
{
    ...
    public static class HtmlHelperControlExtensions
    {
        ...
        //public static HtmlString DatePicker(this HtmlHelper htmlHelper, string name, DateTime? selectedDate = null, string startDate = "", string endDate = "", bool isDaterangepicker = false)
        //{
        ...
        //public static HtmlString DatePickerFor<TModel>(this HtmlHelper<TModel> htmlHelper, Expression<Func<TModel, DateTime>> expression, string minDate = "0", string maxDate = "+10Y", bool isDaterangepicker = false)
        //{
        ...
        ///// <param name="name">name属性</param>
        ///// <param name="dateTimePicker">日期时间选择器控件</param>
        //public static HtmlString TimePicker(this HtmlHelper htmlHelper, string name, DateTime? value)
        //{
        ...
        ///// <param name="expression">选取model中属性的lamda表达式</param>
        ///// <param name="dateTimePicker">日期时间选择器控件</param>
        //public static HtmlString DateTimePickerFor<TModel>(this HtmlHelper<TModel> htmlHelper, Expression<Func<TModel, DateTime>> expression, DateTimePicker dateTimePicker = null, bool isDaterangepicker = false)
        //{
        //    ModelMetadata metadata = ModelMetadata.FromLambdaExpression(expression, htmlHelper.ViewData);
        ...
        //public static HtmlString DateTimePicker(this HtmlHelper htmlHelper, string name, DateTime? selectedDate = null, string minDate = "", string maxDate = "", bool isDaterangepicker = false)
        //{
        ...
        ///// <param name="name">name属性</param>
        ///// <param name="dateTimePicker">日期时间选择器控件</param>
        //public static HtmlString DateTimePicker(this HtmlHelper htmlHelper, string name, DateTimePicker dateTimePicker, bool isDaterangepicker = false)
        //{
        //    if (dateTimePicker == null)
        //        dateTimePicker = new DateTimePicker();
        ...
        public static MvcForm BeginAjaxForm(this HtmlHelper htmlHelper, string actionName, string controllerName, object routeValues, FormMethod method, AjaxFormOptions options, object htmlAttributes)
        {
            ...
            return BeginAjaxForm(htmlHelper, actionName, controllerName, newValues, method, options, 
        ...
        {
            return BeginAjaxRouteForm(htmlHelper, routeName, new RouteValueDictionary(routeValues), method, options, HtmlHelper.AnonymousObjectToHtmlAttributes(htmlAttributes));
        }
        ...
        {
            return null;
           // string formAction = UrlHelper.GenerateUrl(routeName, null /* actionName */, null /* controllerName */, routeValues ?? new RouteValueDictionary(), htmlHelper.RouteCollection, htmlHelper.ViewContext.HttpContext, false /* includeImplicitMvcValues */);
           // return FormHelper(htmlHelper, formAction, method, options, htmlAttributes);
        }
        ...
        private static MvcForm FormHelper(this HtmlHelper htmlHelper, string formAction, FormMethod method, AjaxFormOptions options, IDictionary<string, object> htmlAttributes)
        {
            ...
            htmlHelper.ViewContext.Writer.Write(builder.RenderStartTag().ToString() + htmlHelper.AntiForgeryToken());
        ...
        ///// <returns></returns>
        //public static HtmlString DepartmentSelector(this HtmlHelper htmlHelper, string name, int itemNumber = 0, List<string> selectedValues = null)
        //{
