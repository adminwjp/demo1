...
namespace Tunynet.Common
{
    ...
    public static class HtmlHelperPaginationExtensions
    {
        ...
        /// <returns></returns>
        public static HtmlString PagingButton(this HtmlHelper html, IPagingDataSet pagingDataSet, PaginationMode paginationMode = PaginationMode.NumericNextPrevious)
        {
        ...
        public static HtmlString AjaxPagingButton(this HtmlHelper html, IPagingDataSet pagingDataSet, string updateTargetId, string ajaxLoadUrl = null, PaginationMode paginationMode = PaginationMode.NumericNextPrevious)
        {
        ...
        /// <returns>分页按钮html代码</returns>
        private static HtmlString PagingButton(this HtmlHelper html, IPagingDataSet pagingDataSet, string targetId, string ajaxLoadUrl = null, PaginationMode paginationMode = PaginationMode.NumericNextPrevious)
        {
        ...
        /// <param name="numericPagingButtonCount">数字分页按钮显示个数</param>
        /// <returns>分页按钮html代码</returns>
        public static HtmlString AjaxPagingButtonSearch(this HtmlHelper html, int pageIndex, int pageSize, long totalRecords, string updateTargetId, string ajaxLoadUrl = null, PaginationMode paginationMode = PaginationMode.NumericNextPrevious)
        {
        ...
        /// <param name="enableAjax">是否使用ajax分页</param>
        /// <returns>分页按钮html代码</returns>
        private static HtmlString PagingButtonSearch(this HtmlHelper html, int pageIndex, int pageSize, long totalRecords, string targetId, string ajaxLoadUrl = null, PaginationMode paginationMode = PaginationMode.NumericNextPrevious)
        {
            if (totalRecords < 1)
                totalRecords = 1;
            //未超过一页时不显示分页按钮
