...
{
    [MappTypeAttribute(typeof(AuthorityOperatorEntity))]
    public class AuthorityOperatorViewModel : AuthorityOperatorEntity, INotifyPropertyChanged, IIsSelectedViewModel
    {
