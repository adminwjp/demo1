...
namespace OA.Wpf.ViewModels
{
    ...
    /// 奖惩信息
    /// </summary>
    [MappTypeAttribute(typeof(ReawrdsAndPunishmentEntity))]
    public class ReawrdsAndPunishmentViewModel : ReawrdsAndPunishmentEntity, INotifyPropertyChanged, IIsSelectedViewModel
    {
