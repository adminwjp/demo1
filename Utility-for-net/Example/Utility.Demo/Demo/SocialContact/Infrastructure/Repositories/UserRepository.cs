...
{
    [Transtation]
    public class UserRepository : BaseNhibernateRepository<UserEntity, long>
    {
        /// <summary>
        /// 
        /// </summary>
        /// <param name="session"></param>
        public UserRepository(SessionProvider session) : base(session)
        {
        ...
        //public UserRepository(Lazy<SessionProvider> writeSession, Lazy<SessionProvider> readSession) : base(writeSession, readSession)
        //{
