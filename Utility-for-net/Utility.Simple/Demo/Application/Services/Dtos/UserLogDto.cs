...
namespace Utility.Demo.Application.Services.Dtos
{
    ...
    public class UserLogDto: UserLogDto<long>
    {

    }
   /// <summary>用户日志 </summary>
    public class UserLogDto<Key> : Entity<Key>
    {
        ...
        {
            get => newEmail; set{Set(ref newEmail, value, "NewEmail"); } }
        ...
        public virtual DateTime AddDate { get => addDate; set { Set(ref addDate, value, "AddDate"); } }
