...
namespace Utility.Demo.Application.Services.Dtos
{
    ...
    public class TokenDto : TokenDto<long>
    {

    }
    /// <summary>用户 token </summary>
    public class TokenDto<Key> : Entity<Key>
    {
        private string token;
        private DateTime tokenExpried;
        private string refreshToken;
        private DateTime createDate;
        private Key userId;
        private int flag;
        private DateTime refreshTokenExpried;

        /// <summary>用户 token  </summary>
        public virtual string Token { get => token; set { Set(ref token, value, "Token"); } }
        /// <summary>用户 token 过期时间 单位 秒 </summary>
        public virtual DateTime TokenExpried { get => tokenExpried; set { Set(ref tokenExpried, value, "TokenExpried"); } }
        ...
        public virtual DateTime RefreshTokenExpried { get => refreshTokenExpried; set { Set(ref refreshTokenExpried, value, "RefreshTokenExpried"); } }
        /// <summary>用户 创建 token 时间  </summary>
        public virtual DateTime CreateDate { get => createDate; set { Set(ref createDate, value, "CreateDate"); } }
