...
namespace Utility.Demo.Application.Services.Dtos
{
    ...
    public class MenuDto<Menu, Key> : EntityDto<Key>//,ICascade<Menu, Key>
      where Menu : MenuDto<Menu, Key>
    {
        ...
        private DateTime? _lastModificationTime;//更新时间
        private DateTime? _deletionTime;//软删除时间
        ...
        /// <summary>菜单信息 </summary>
        public MenuDto(bool create = true)
        {
            if (create)
            {
                Create();
        ...
        public virtual MenuDto<Menu, Key>
            Create()
        {
        ...
        public virtual DateTime? CreationTime { get { return this._creationTime; } set { Set(ref _creationTime, value, "CreationTime"); } }
        /// <summary>更新时间</summary>
        public virtual DateTime? LastModificationTime { get { return this._lastModificationTime; } set { Set(ref _lastModificationTime, value, "LastModificationTime"); } }
        ...
        public virtual DateTime? DeletionTime { get { return this._deletionTime; } set { Set(ref _deletionTime, value, "DeletionTime"); } }
