...
namespace Utility.Demo.Domain.Entities
{
    ...
    public class AdminEntity: BaseUserEntity<AdminEntity,long>
    {
        public virtual long RoleId { get; set; }
    }
    public abstract class BaseUserEntity<User, Key> : Entity<Key>
        where User : BaseUserEntity<User, Key>
    {
        ...
        public virtual long Birthday { get => birthday; set { Set(ref birthday, value, "Birthday"); } }
        ...
        public virtual long RegisterDate { get => registerDate; set { Set(ref registerDate, value, "RegisterDate"); } }
        /// <summary>用户登录时间 </summary>
        public virtual long LoginDate { get => loginDate; set { Set(ref loginDate, value, "LoginDate"); } }
        ...
        public virtual Key parent_id { get => parentId; set { Set(ref parentId, value, "parent_id"); } }
    ...
    /// <summary>用户 </summary>
    public class UserEntity<User, Key> : BaseUserEntity<User, Key>, IEntity<Key>
        where User : BaseUserEntity<User, Key>
    {
