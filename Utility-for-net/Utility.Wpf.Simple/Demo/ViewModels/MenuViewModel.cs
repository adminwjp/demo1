...
{
    public class MenuViewModel: MenuViewModel<MenuViewModel,long>
    {

    }
    public class MenuViewModel<ViewModel,Key> : MenuDto<ViewModel, Key>, IIsSelectedViewModel, INotifyPropertyChanged
        where ViewModel: MenuViewModel<ViewModel, Key>
    {
