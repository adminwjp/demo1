...
{
    public class CityViewModel : CityViewModel<CityViewModel,long>
    {

    }
    public class CityViewModel<ViewModel,Key> : CityEntity<ViewModel, Key>, IIsSelectedViewModel, INotifyPropertyChanged
        where ViewModel: CityViewModel<ViewModel, Key>
    {
