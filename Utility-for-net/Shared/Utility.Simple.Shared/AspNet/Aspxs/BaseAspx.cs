...
namespace Utility.AspNet.Aspxs
{
    /// <summary>
    /// 基础 aspx 接口
    /// </summary>
    /// <typeparam name="ResponseApiServiceImpl"></typeparam>
    /// <typeparam name="ServiceImpl"></typeparam>
    /// <typeparam name="T"></typeparam>
    /// <typeparam name="Key"></typeparam>
    public class BaseAspx<ResponseApiServiceImpl,ServiceImpl, T, Key> : System.Web.UI.Page
        ...
        where T : class, IEntity<Key>
    {
        ...
        {
            ProcessRequest1(Context);//等价 handler
        }
        ...
        public void ProcessRequest1(HttpContext context)
        {
            ...
            switch (m)
            {
                ...
                case "update":
                    {
                        responseApi = ApiService.Update(obj);
                    }
                    break;
                case "delete":
                    {
