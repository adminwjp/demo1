...
namespace Utility.Wcf
{
    ...
    public    interface IServiceApi<Entity,Key> where Entity:class,IEntity<Key>
    {
        ...
        ResponseApi<long> Count(Entity obj,Language language= Language.Chinese);
        ...
        ResponseApi<ResultDto<Entity>> FindResultByPage(Entity obj,int page,int size,Language language= Language.Chinese);
    }
